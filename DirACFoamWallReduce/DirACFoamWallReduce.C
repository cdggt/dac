...
namespace solvers
{
    defineTypeNameAndDebug(DirACFoamWallReduce, 0);
    addToRunTimeSelectionTable(solver, DirACFoamWallReduce, fvMesh);
}
}
...
void Foam::solvers::DirACFoamWallReduce::correctCoNum()
{
    fluidSolver::correctCoNum(phi);
}

// Used to set maximum time step based on diffusion
void Foam::solvers::DirACFoamWallReduce::correctDiNum()
{
...
void Foam::solvers::DirACFoamWallReduce::continuityErrors()
{
...
Foam::solvers::DirACFoamWallReduce::DirACFoamWallReduce(fvMesh& mesh)
:
    fluidSolver(mesh),
	...
	mesh,
	dimensionedScalar("XvInitial",dimless,.5)
    ),
...
Foam::solvers::DirACFoamWallReduce::~DirACFoamWallReduce()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::DirACFoamWallReduce::readControls()
{
...
Foam::scalar Foam::solvers::DirACFoamWallReduce::maxDeltaT() const
{
...
void Foam::solvers::DirACFoamWallReduce::preSolve()
{
    // Read the controls
    readControls();
...
void Foam::solvers::DirACFoamWallReduce::prePredictor()
{
...
void Foam::solvers::DirACFoamWallReduce::pressureCorrector()
{
...
void Foam::solvers::DirACFoamWallReduce::postCorrector()
{
...
void Foam::solvers::DirACFoamWallReduce::postSolve()
{}
